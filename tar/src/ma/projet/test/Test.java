...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        Homme h1 = new Homme("Ismail", "Sorhrani", "4856978956", "fdfe", new Date(1984 - 1900, 4, 3));
        ...
        Femme f1 =  new Femme("malak1", "lol1", "04874884", "atebfdfan", new Date(1992 - 1900, 1, 5));
         Femme f2 =  new Femme("malak1", "lol1", "04874884", "atebfdfan", new Date(1992 - 1900, 1, 5));
          Femme f3 =  new Femme("malak1", "lol1", "04874884", "atebfdfan", new Date(1992 - 1900, 1, 5));
           Femme f4 =  new Femme("malak1", "lol1", "04874884", "atebfdfan", new Date(1992 - 1900, 1, 5));
        Femme f5 =  new Femme("malak1", "lol1", "04874884", "atebfdfan", new Date(1992 - 1900, 1, 5));
        Femme f6 = new Femme("malak2", "lol2", "04874884", "grgr", new Date(1995 - 1900, 4, 3));
        Femme f7 =  new Femme("malak3", "lol3", "04874884", "atebfdfan", new Date(1980 - 1900, 4, 3));
        Femme f8 = new Femme("malak4", "lol4", "04874884", "grgr", new Date(1979 - 1900, 4, 3));
        Femme f9 =  new Femme("malak5", "lol5", "04874884", "atebfdfan", new Date(1988 - 1900, 11, 3));
        Femme f10 = new Femme("malak6", "lol6", "04874884", "grgr", new Date(1984 - 1900, 6, 3));
